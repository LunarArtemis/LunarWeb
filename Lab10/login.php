...
if (isset($_SESSION['error_regis'])) {
    echo "<script>
    swal({
        title: 'username นี้มีผู้ใช้งานแล้ว',
...
<body class="bg-gray-50 dark:bg-gray-900">
    <section class=" bg-gray-50 dark:bg-gray-900" data-role="page" id="loginSection">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="chklogin.php" method="POST">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don’t have an account yet? <a href="#regisSection" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Sign up</a>
                        </p>
                        <?php if (isset($_SESSION['error_msg']))
                            // wrong username or password and try again swal
    ...
    <section class=" bg-gray-50 dark:bg-gray-900" data-role="page" id="regisSection">
        <div class="flex items-center justify-center h-screen px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="bg-white rounded-lg shadow w-auto dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1 class="text-2xl font-bold leading-tight tracking-tight text-blue-600 md:text-2xl dark:text-white">
                    ...
                    <form class="space-y-4 md:space-y-6" action="crtregis.php" method="POST">
                        <label for="user-icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your username</label>
                        <div class="relative">
                            <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500 dark:text-gray-400">
                        ...
                        <!-- register button -->
                        <button type="submit" class="w-full px-4 py-2 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue" id="register">
                            Register
                        </button>

                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="#loginSection" class="font-medium text-blue-600 hover:underline dark:text-blue-500" data-section="#loginSection">Sign in</a>
                        </p>
